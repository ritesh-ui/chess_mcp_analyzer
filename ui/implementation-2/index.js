document.addEventListener("DOMContentLoaded", function () {
    ...
    function toggleSettings(disable) {
        const settingsDiv = document.getElementById('collapseOne');
        ...
        // Disable color toggle buttons visually as well
        const colorLabels = settingsDiv.querySelectorAll('.btn-outline-primary');
